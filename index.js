...
const displayString = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} game${totalGames !== 1 ? 's' : ''}. Currently, ${numUnfundedGames} game${numUnfundedGames !== 1 ? 's' : ''} remain unfunded. We need your help to fund these amazing games!`;
...
// Create a new element for the top funded game and append it to the firstGameContainer
